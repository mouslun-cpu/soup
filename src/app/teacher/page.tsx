...
const DEMO_STORIES = [
  {
    title: "自殺的男人",
    content:
      "一個男人走進一家餐廳，點了一碗烏龜湯。喝了一口之後，他回到家裡，拿出槍，自殺了。",
    true_need:
      "這個男人曾和妻子一起在荒島上迷路，在最絕望的時刻，同行者告訴他喝的是烏龜湯讓他活下去。多年後他發現那並不是烏龜湯——妻子早已去世，被同伴用來熬湯，而真正的烏龜湯讓他想起了這個真相。",
  },
  {
    title: "電梯之謎",
  ...
  },
  {
    title: "血糖App之謎",
    content:
      "某知名大醫院為了照顧高齡糖尿病患者，花重金開發了一款「血糖超標警報 APP」。為了體貼長輩，這款 APP 介面字體超大、完全免費，而且連接穿戴裝置，測量極度精準。上線第一週，門診的阿公、阿嬤們下載率高達 90%，醫護人員非常振奮。但是到了第二週，後台數據卻出現了一個極度詭異的現象：幾乎所有的「阿公」都把 APP 刪除了，可是「阿嬤」們卻都留著繼續使用。請問：這款救命的 APP，為什麼會被阿公們集體退貨？",
    true_need:
